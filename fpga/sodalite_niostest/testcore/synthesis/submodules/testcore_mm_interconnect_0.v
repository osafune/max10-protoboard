...
// 
// Generated using ACDS version 14.0 209 at 2014.11.14.01:06:31
...
module testcore_mm_interconnect_0 (
	...
	wire  [107:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [107:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire   [28:0] onchip_flash_0_data_agent_m0_address;                                               // onchip_flash_0_data_agent:m0_address -> onchip_flash_0_data_translator:uav_address
	...
	wire  [107:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> onchip_flash_0_data_agent:cp_data
	...
	wire  [108:0] peripheral_bridge_s0_agent_rf_source_data;                                          // peripheral_bridge_s0_agent:rf_source_data -> peripheral_bridge_s0_agent_rsp_fifo:in_data
	...
	wire  [108:0] peripheral_bridge_s0_agent_rsp_fifo_out_data;                                       // peripheral_bridge_s0_agent_rsp_fifo:out_data -> peripheral_bridge_s0_agent:rf_sink_data
	...
	wire  [107:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> peripheral_bridge_s0_agent:cp_data
	...
	wire  [107:0] nios2_gen2_0_instruction_master_agent_cp_data;                                      // nios2_gen2_0_instruction_master_agent:cp_data -> router:sink_data
	...
	wire  [107:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [107:0] onchip_flash_0_data_agent_rp_data;                                                  // onchip_flash_0_data_agent:rp_data -> router_004:sink_data
	...
	wire   [89:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_005:sink_data
	wire          sdram_s1_agent_rp_ready;                                                            // router_005:sink_ready -> sdram_s1_agent:rp_ready
	wire          peripheral_bridge_s0_agent_rp_endofpacket;                                          // peripheral_bridge_s0_agent:rp_endofpacket -> router_006:sink_endofpacket
	wire          peripheral_bridge_s0_agent_rp_valid;                                                // peripheral_bridge_s0_agent:rp_valid -> router_006:sink_valid
	wire          peripheral_bridge_s0_agent_rp_startofpacket;                                        // peripheral_bridge_s0_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire  [107:0] peripheral_bridge_s0_agent_rp_data;                                                 // peripheral_bridge_s0_agent:rp_data -> router_006:sink_data
	wire          peripheral_bridge_s0_agent_rp_ready;                                                // router_006:sink_ready -> peripheral_bridge_s0_agent:rp_ready
	...
	wire          router_src_endofpacket;                                                             // router:src_endofpacket -> nios2_gen2_0_instruction_master_limiter:cmd_sink_endofpacket
	wire          router_src_valid;                                                                   // router:src_valid -> nios2_gen2_0_instruction_master_limiter:cmd_sink_valid
	wire          router_src_startofpacket;                                                           // router:src_startofpacket -> nios2_gen2_0_instruction_master_limiter:cmd_sink_startofpacket
	wire  [107:0] router_src_data;                                                                    // router:src_data -> nios2_gen2_0_instruction_master_limiter:cmd_sink_data
	wire    [4:0] router_src_channel;                                                                 // router:src_channel -> nios2_gen2_0_instruction_master_limiter:cmd_sink_channel
	wire          router_src_ready;                                                                   // nios2_gen2_0_instruction_master_limiter:cmd_sink_ready -> router:src_ready
	wire          nios2_gen2_0_instruction_master_limiter_cmd_src_endofpacket;                        // nios2_gen2_0_instruction_master_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire          nios2_gen2_0_instruction_master_limiter_cmd_src_startofpacket;                      // nios2_gen2_0_instruction_master_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire  [107:0] nios2_gen2_0_instruction_master_limiter_cmd_src_data;                               // nios2_gen2_0_instruction_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire    [4:0] nios2_gen2_0_instruction_master_limiter_cmd_src_channel;                            // nios2_gen2_0_instruction_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire          nios2_gen2_0_instruction_master_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> nios2_gen2_0_instruction_master_limiter:cmd_src_ready
	wire          rsp_mux_src_endofpacket;                                                            // rsp_mux:src_endofpacket -> nios2_gen2_0_instruction_master_limiter:rsp_sink_endofpacket
	wire          rsp_mux_src_valid;                                                                  // rsp_mux:src_valid -> nios2_gen2_0_instruction_master_limiter:rsp_sink_valid
	wire          rsp_mux_src_startofpacket;                                                          // rsp_mux:src_startofpacket -> nios2_gen2_0_instruction_master_limiter:rsp_sink_startofpacket
	wire  [107:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_gen2_0_instruction_master_limiter:rsp_sink_data
	wire    [4:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_gen2_0_instruction_master_limiter:rsp_sink_channel
	wire          rsp_mux_src_ready;                                                                  // nios2_gen2_0_instruction_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	...
	wire   [89:0] router_005_src_data;                                                                // router_005:src_data -> sdram_s1_rsp_width_adapter:in_data
	...
	wire    [4:0] nios2_gen2_0_instruction_master_limiter_cmd_valid_data;                             // nios2_gen2_0_instruction_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	testcore_mm_interconnect_0_router_002 router_003 (
	...
	testcore_mm_interconnect_0_router_002 router_004 (
	...
	testcore_mm_interconnect_0_router_005 router_005 (
	...
	testcore_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_core_clk_clk),                               //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testcore_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_core_clk_clk),                               //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
