...
# Memory: ipl_memory
MEM_0 := testcore_ipl_memory
$(MEM_0)_NAME := ipl_memory
...
$(MEM_0)_END := 0x0f001fff
$(MEM_0)_SPAN := 0x00002000
$(MEM_0)_HIERARCHICAL_PATH := ipl_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: ipl_memory
ipl_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
...
$(MEM_1)_START := 0x0f100000
$(MEM_1)_END := 0x0f107fff
