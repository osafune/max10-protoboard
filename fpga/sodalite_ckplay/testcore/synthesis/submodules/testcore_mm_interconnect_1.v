...
// 
// Generated using ACDS version 14.0 209 at 2014.11.16.01:22:55
...
module testcore_mm_interconnect_1 (
	...
	wire  [92:0] systimer_s1_agent_rf_source_data;                                        // systimer_s1_agent:rf_source_data -> systimer_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] systimer_s1_agent_rsp_fifo_out_data;                                     // systimer_s1_agent_rsp_fifo:out_data -> systimer_s1_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_001_src_data;                                                    // cmd_mux_001:src_data -> systimer_s1_agent:cp_data
	wire   [8:0] cmd_mux_001_src_channel;                                                 // cmd_mux_001:src_channel -> systimer_s1_agent:cp_channel
	...
	wire  [92:0] onchip_flash_0_csr_agent_rf_source_data;                                 // onchip_flash_0_csr_agent:rf_source_data -> onchip_flash_0_csr_agent_rsp_fifo:in_data
	...
	wire  [92:0] onchip_flash_0_csr_agent_rsp_fifo_out_data;                              // onchip_flash_0_csr_agent_rsp_fifo:out_data -> onchip_flash_0_csr_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_004_src_data;                                                    // cmd_mux_004:src_data -> onchip_flash_0_csr_agent:cp_data
	wire   [8:0] cmd_mux_004_src_channel;                                                 // cmd_mux_004:src_channel -> onchip_flash_0_csr_agent:cp_channel
	...
	wire  [92:0] modular_adc_0_sequencer_csr_agent_rf_source_data;                        // modular_adc_0_sequencer_csr_agent:rf_source_data -> modular_adc_0_sequencer_csr_agent_rsp_fifo:in_data
	...
	wire  [92:0] modular_adc_0_sequencer_csr_agent_rsp_fifo_out_data;                     // modular_adc_0_sequencer_csr_agent_rsp_fifo:out_data -> modular_adc_0_sequencer_csr_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_endofpacket;                                             // cmd_mux_005:src_endofpacket -> modular_adc_0_sequencer_csr_agent:cp_endofpacket
	wire         cmd_mux_005_src_valid;                                                   // cmd_mux_005:src_valid -> modular_adc_0_sequencer_csr_agent:cp_valid
	wire         cmd_mux_005_src_startofpacket;                                           // cmd_mux_005:src_startofpacket -> modular_adc_0_sequencer_csr_agent:cp_startofpacket
	wire  [91:0] cmd_mux_005_src_data;                                                    // cmd_mux_005:src_data -> modular_adc_0_sequencer_csr_agent:cp_data
	wire   [8:0] cmd_mux_005_src_channel;                                                 // cmd_mux_005:src_channel -> modular_adc_0_sequencer_csr_agent:cp_channel
	wire         cmd_mux_005_src_ready;                                                   // modular_adc_0_sequencer_csr_agent:cp_ready -> cmd_mux_005:src_ready
	...
	wire  [92:0] modular_adc_0_sample_store_csr_agent_rf_source_data;                     // modular_adc_0_sample_store_csr_agent:rf_source_data -> modular_adc_0_sample_store_csr_agent_rsp_fifo:in_data
	...
	wire  [92:0] modular_adc_0_sample_store_csr_agent_rsp_fifo_out_data;                  // modular_adc_0_sample_store_csr_agent_rsp_fifo:out_data -> modular_adc_0_sample_store_csr_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_endofpacket;                                             // cmd_mux_006:src_endofpacket -> modular_adc_0_sample_store_csr_agent:cp_endofpacket
	wire         cmd_mux_006_src_valid;                                                   // cmd_mux_006:src_valid -> modular_adc_0_sample_store_csr_agent:cp_valid
	wire         cmd_mux_006_src_startofpacket;                                           // cmd_mux_006:src_startofpacket -> modular_adc_0_sample_store_csr_agent:cp_startofpacket
	wire  [91:0] cmd_mux_006_src_data;                                                    // cmd_mux_006:src_data -> modular_adc_0_sample_store_csr_agent:cp_data
	wire   [8:0] cmd_mux_006_src_channel;                                                 // cmd_mux_006:src_channel -> modular_adc_0_sample_store_csr_agent:cp_channel
	wire         cmd_mux_006_src_ready;                                                   // modular_adc_0_sample_store_csr_agent:cp_ready -> cmd_mux_006:src_ready
	...
	wire  [15:0] mmcdma_s1_agent_m0_address;                                              // mmcdma_s1_agent:m0_address -> mmcdma_s1_translator:uav_address
	...
	wire  [92:0] mmcdma_s1_agent_rf_source_data;                                          // mmcdma_s1_agent:rf_source_data -> mmcdma_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] mmcdma_s1_agent_rsp_fifo_out_data;                                       // mmcdma_s1_agent_rsp_fifo:out_data -> mmcdma_s1_agent:rf_sink_data
	wire         mmcdma_s1_agent_rsp_fifo_out_ready;                                      // mmcdma_s1_agent:rf_sink_ready -> mmcdma_s1_agent_rsp_fifo:out_ready
	wire         mmcdma_s1_agent_rdata_fifo_src_valid;                                    // mmcdma_s1_agent:rdata_fifo_src_valid -> mmcdma_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] mmcdma_s1_agent_rdata_fifo_src_data;                                     // mmcdma_s1_agent:rdata_fifo_src_data -> mmcdma_s1_agent:rdata_fifo_sink_data
	wire         mmcdma_s1_agent_rdata_fifo_src_ready;                                    // mmcdma_s1_agent:rdata_fifo_sink_ready -> mmcdma_s1_agent:rdata_fifo_src_ready
	wire         cmd_mux_007_src_endofpacket;                                             // cmd_mux_007:src_endofpacket -> mmcdma_s1_agent:cp_endofpacket
	wire         cmd_mux_007_src_valid;                                                   // cmd_mux_007:src_valid -> mmcdma_s1_agent:cp_valid
	wire         cmd_mux_007_src_startofpacket;                                           // cmd_mux_007:src_startofpacket -> mmcdma_s1_agent:cp_startofpacket
	wire  [91:0] cmd_mux_007_src_data;                                                    // cmd_mux_007:src_data -> mmcdma_s1_agent:cp_data
	wire   [8:0] cmd_mux_007_src_channel;                                                 // cmd_mux_007:src_channel -> mmcdma_s1_agent:cp_channel
	wire         cmd_mux_007_src_ready;                                                   // mmcdma_s1_agent:cp_ready -> cmd_mux_007:src_ready
	...
	wire  [15:0] vga_s1_agent_m0_address;                                                 // vga_s1_agent:m0_address -> vga_s1_translator:uav_address
	...
	wire  [92:0] vga_s1_agent_rf_source_data;                                             // vga_s1_agent:rf_source_data -> vga_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] vga_s1_agent_rsp_fifo_out_data;                                          // vga_s1_agent_rsp_fifo:out_data -> vga_s1_agent:rf_sink_data
	wire         vga_s1_agent_rsp_fifo_out_ready;                                         // vga_s1_agent:rf_sink_ready -> vga_s1_agent_rsp_fifo:out_ready
	wire         vga_s1_agent_rdata_fifo_src_valid;                                       // vga_s1_agent:rdata_fifo_src_valid -> vga_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] vga_s1_agent_rdata_fifo_src_data;                                        // vga_s1_agent:rdata_fifo_src_data -> vga_s1_agent:rdata_fifo_sink_data
	wire         vga_s1_agent_rdata_fifo_src_ready;                                       // vga_s1_agent:rdata_fifo_sink_ready -> vga_s1_agent:rdata_fifo_src_ready
	wire         cmd_mux_008_src_endofpacket;                                             // cmd_mux_008:src_endofpacket -> vga_s1_agent:cp_endofpacket
	wire         cmd_mux_008_src_valid;                                                   // cmd_mux_008:src_valid -> vga_s1_agent:cp_valid
	wire         cmd_mux_008_src_startofpacket;                                           // cmd_mux_008:src_startofpacket -> vga_s1_agent:cp_startofpacket
	wire  [91:0] cmd_mux_008_src_data;                                                    // cmd_mux_008:src_data -> vga_s1_agent:cp_data
	wire   [8:0] cmd_mux_008_src_channel;                                                 // cmd_mux_008:src_channel -> vga_s1_agent:cp_channel
	wire         cmd_mux_008_src_ready;                                                   // vga_s1_agent:cp_ready -> cmd_mux_008:src_ready
	...
	wire  [91:0] peripheral_bridge_m0_agent_cp_data;                                      // peripheral_bridge_m0_agent:cp_data -> router:sink_data
	...
	wire  [91:0] systimer_s1_agent_rp_data;                                               // systimer_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [91:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                               // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [91:0] led_s1_agent_rp_data;                                                    // led_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [91:0] onchip_flash_0_csr_agent_rp_data;                                        // onchip_flash_0_csr_agent:rp_data -> router_005:sink_data
	...
	wire         modular_adc_0_sequencer_csr_agent_rp_endofpacket;                        // modular_adc_0_sequencer_csr_agent:rp_endofpacket -> router_006:sink_endofpacket
	wire         modular_adc_0_sequencer_csr_agent_rp_valid;                              // modular_adc_0_sequencer_csr_agent:rp_valid -> router_006:sink_valid
	wire         modular_adc_0_sequencer_csr_agent_rp_startofpacket;                      // modular_adc_0_sequencer_csr_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire  [91:0] modular_adc_0_sequencer_csr_agent_rp_data;                               // modular_adc_0_sequencer_csr_agent:rp_data -> router_006:sink_data
	wire         modular_adc_0_sequencer_csr_agent_rp_ready;                              // router_006:sink_ready -> modular_adc_0_sequencer_csr_agent:rp_ready
	...
	wire  [91:0] modular_adc_0_sample_store_csr_agent_rp_data;                            // modular_adc_0_sample_store_csr_agent:rp_data -> router_007:sink_data
	...
	wire  [91:0] router_007_src_data;                                                     // router_007:src_data -> rsp_demux_006:sink_data
	...
	wire         mmcdma_s1_agent_rp_endofpacket;                                          // mmcdma_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	wire         mmcdma_s1_agent_rp_valid;                                                // mmcdma_s1_agent:rp_valid -> router_008:sink_valid
	wire         mmcdma_s1_agent_rp_startofpacket;                                        // mmcdma_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire  [91:0] mmcdma_s1_agent_rp_data;                                                 // mmcdma_s1_agent:rp_data -> router_008:sink_data
	wire         mmcdma_s1_agent_rp_ready;                                                // router_008:sink_ready -> mmcdma_s1_agent:rp_ready
	...
	wire  [91:0] router_008_src_data;                                                     // router_008:src_data -> rsp_demux_007:sink_data
	...
	wire         vga_s1_agent_rp_endofpacket;                                             // vga_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	wire         vga_s1_agent_rp_valid;                                                   // vga_s1_agent:rp_valid -> router_009:sink_valid
	wire         vga_s1_agent_rp_startofpacket;                                           // vga_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire  [91:0] vga_s1_agent_rp_data;                                                    // vga_s1_agent:rp_data -> router_009:sink_data
	wire         vga_s1_agent_rp_ready;                                                   // router_009:sink_ready -> vga_s1_agent:rp_ready
	...
	wire  [91:0] router_009_src_data;                                                     // router_009:src_data -> rsp_demux_008:sink_data
	...
	wire  [91:0] router_src_data;                                                         // router:src_data -> peripheral_bridge_m0_limiter:cmd_sink_data
	wire   [8:0] router_src_channel;                                                      // router:src_channel -> peripheral_bridge_m0_limiter:cmd_sink_channel
	...
	wire  [91:0] peripheral_bridge_m0_limiter_cmd_src_data;                               // peripheral_bridge_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	wire   [8:0] peripheral_bridge_m0_limiter_cmd_src_channel;                            // peripheral_bridge_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [91:0] rsp_mux_src_data;                                                        // rsp_mux:src_data -> peripheral_bridge_m0_limiter:rsp_sink_data
	wire   [8:0] rsp_mux_src_channel;                                                     // rsp_mux:src_channel -> peripheral_bridge_m0_limiter:rsp_sink_channel
	...
	wire  [91:0] peripheral_bridge_m0_limiter_rsp_src_data;                               // peripheral_bridge_m0_limiter:rsp_src_data -> peripheral_bridge_m0_agent:rp_data
	wire   [8:0] peripheral_bridge_m0_limiter_rsp_src_channel;                            // peripheral_bridge_m0_limiter:rsp_src_channel -> peripheral_bridge_m0_agent:rp_channel
	...
	wire  [91:0] cmd_demux_src4_data;                                                     // cmd_demux:src4_data -> crosser:in_data
	wire   [8:0] cmd_demux_src4_channel;                                                  // cmd_demux:src4_channel -> crosser:in_channel
	...
	wire  [91:0] crosser_out_data;                                                        // crosser:out_data -> cmd_mux_004:sink0_data
	wire   [8:0] crosser_out_channel;                                                     // crosser:out_channel -> cmd_mux_004:sink0_channel
	...
	wire  [91:0] rsp_demux_004_src0_data;                                                 // rsp_demux_004:src0_data -> crosser_001:in_data
	wire   [8:0] rsp_demux_004_src0_channel;                                              // rsp_demux_004:src0_channel -> crosser_001:in_channel
	...
	wire  [91:0] crosser_001_out_data;                                                    // crosser_001:out_data -> rsp_mux:sink4_data
	wire   [8:0] crosser_001_out_channel;                                                 // crosser_001:out_channel -> rsp_mux:sink4_channel
	wire         crosser_001_out_ready;                                                   // rsp_mux:sink4_ready -> crosser_001:out_ready
	wire   [8:0] peripheral_bridge_m0_limiter_cmd_valid_data;                             // peripheral_bridge_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (mmcdma_s1_agent_rdata_fifo_src_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (mmcdma_s1_agent_rdata_fifo_src_valid),                //                .valid
		.rdata_fifo_sink_data    (mmcdma_s1_agent_rdata_fifo_src_data),                 //                .data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (vga_s1_agent_rdata_fifo_src_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (vga_s1_agent_rdata_fifo_src_valid),                   //                .valid
		.rdata_fifo_sink_data    (vga_s1_agent_rdata_fifo_src_data),                    //                .data
	...
	testcore_mm_interconnect_1_router_005 router_005 (
	...
	testcore_mm_interconnect_1_router_001 router_006 (
	...
	testcore_mm_interconnect_1_router_001 router_009 (
	...
	testcore_mm_interconnect_1_cmd_mux_004 cmd_mux_004 (
		.clk                 (clk_core_clk_clk),                                  //       clk.clk
		.reset               (onchip_flash_0_nreset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testcore_mm_interconnect_1_cmd_mux cmd_mux_005 (
		.clk                 (clk_peri_clk_clk),                                    //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testcore_mm_interconnect_1_cmd_mux cmd_mux_008 (
		.clk                 (clk_peri_clk_clk),                                    //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testcore_mm_interconnect_1_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_core_clk_clk),                                  //       clk.clk
		.reset              (onchip_flash_0_nreset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testcore_mm_interconnect_1_rsp_demux rsp_demux_005 (
		.clk                (clk_peri_clk_clk),                                    //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testcore_mm_interconnect_1_rsp_demux rsp_demux_008 (
		.clk                (clk_peri_clk_clk),                                    //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
